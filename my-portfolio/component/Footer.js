          ...
          <div className="container ">
            ...
            <form className="formulario">
              <div className="formularioInt">
                ...
                <input type="text" name="name" className="inputField" onChange={(e) => { setName(e.target.value) }} ></input>
              </div>
              <div className="formularioInt">
                <label htmlFor="email">Email</label>
                <input type="email" name="email" className="inputField" onChange={(e) => {setEmail(e.target.value) }} ></input>
              </div>
              <div className="formularioInt">
                <label htmlFor="texto" >Menasaje</label>
                <textarea type="text" name="texto" className="inputField" onChange={(e) => { setTexto(e.target.value) }} ></textarea>
              </div>
              <div >
